...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
    ...
    $phone = $_POST["phone"];
		...
		$sql = "INSERT INTO `britishcat`(`Name`,`Email`, `Colour`, `Age`, `Gender`, `City`, `Address`, `Phone`) VALUES ('$fullname','$email', '$colour','$age', '$gender','$city', '$address','$phone')";
            ...
            <div class="bg-white border rounded shadow-sm overflow-hidden">
              ...
              <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                  ...
                  <div class="col-12">
                    <label for="fullname" class="form-label">Cat Age <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="age" name="age" value="" required>
                  </div>

                  <div class="col-12">
                    <label for="fullname" class="form-label">Cat Gender <span class="text-danger">*</span></label>
