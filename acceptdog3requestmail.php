...
$sql = "SELECT email FROM bordercolliedog";
...
if (mysqli_num_rows($result) > 0) 
{
  ...
  {
    $to_email = $row["email"];
    $subject = "Accepting the Border Collie Dog Adopt Request";
    $body = "Hello Sir/Mam,
                 We are greatful to inform you that your adoption request for border collie dog
