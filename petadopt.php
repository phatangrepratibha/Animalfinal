                          ...
                          <img src="images/cat.jpg" height="350px" class="card-img-top" alt="...">
                           <div class="card-body">
                             <h5 class="card-title">CAT</h5>
                              <a href="allcatadopt.php" class="btn btn-success">See More Details</a>
                            </div>
                    </div>
                          ...
                          <img src="images/dd.jpg" height="350px" class="card-img-top" alt="...">
                           <div class="card-body">
                             <h5 class="card-title">DOG</h5>
                              <a href="alldogadopt.php" class="btn btn-success">See More Details</a>
                            </div>
                    </div>
                          ...
                          <img src="images/co.jpg"height="350px"  class="card-img-top" alt="...">
                           <div class="card-body">
                             <h5 class="card-title">COW</h5>
                              <a href="allcowadopt.php" class="btn btn-success">See More Details</a>
                            </div>
                    </div>
                          ...
                          <img src="images/bi.jpg "height="350px" class="card-img-top" alt="...">
                           <div class="card-body">
                             <h5 class="card-title">BIRDS</h5>
                              <a href="allbirdadopt.php" class="btn btn-success">See More Details</a>
                            </div>
                    </div>
                          ...
                          <img src="images/go.jpg" height="350px"class="card-img-top" alt="...">
                           <div class="card-body">
                             <h5 class="card-title">GOAT</h5>
                              <a href="allgoatadopt.php" class="btn btn-success">See More Details</a>
                            </div>
                    </div>
                          ...
                          <img src="images/a.jpg" height="350px" class="card-img-top" alt="...">
                           <div class="card-body">
                             <h5 class="card-title">RABBIT</h5>
                              <a href="allrabbitadopt.php" class="btn btn-success">See More Details</a>
                            </div>
                    </div>
