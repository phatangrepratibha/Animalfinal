...
if (isset($_POST['accept']) && isset($_POST['email'])) 
{
    ...
    $subject = "Accepting the Ragdoll Cat Adoption Request";
    $body = "Hello Sir/Mam,
            We are grateful to inform you that your adoption request of ragdoll cat
    ...
    {
        $sql_select = "SELECT * FROM ragdollcat WHERE Email='$to_email'";
        ...
        if ($result && mysqli_num_rows($result) > 0) 
        {
            ...
            {
                $sql_delete = "DELETE FROM ragdollcat WHERE Email='$to_email'";
