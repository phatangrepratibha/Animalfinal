...
$sql = "SELECT email FROM goldenretriever";
...
if (mysqli_num_rows($result) > 0) 
{
  ...
  {
    $to_email = $row["email"];
    $subject = "Accepting the Golden Retriever Dog Adopt Request";
    $body = "Hello Sir/Mam,
                 We are greatful to inform you that your adoption request for golden retriever dog
