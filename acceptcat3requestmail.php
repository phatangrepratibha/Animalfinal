...
if (mysqli_num_rows($result) > 0) 
{
  ...
  {
    $to_email = $row["email"];
    $subject = "Accepting the Siamese Cat Adoption Request";
    $body = "Hello Sir/Mam,
                 We are greatful to inform you that your adoption request of siamese cat
