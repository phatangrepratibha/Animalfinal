...
if (isset($_POST['accept']) && isset($_POST['email'])) 
{
    ...
    $body = "Hello Sir/Mam,
            We are grateful to inform you that your adoption request of british short hair cat
    ...
    {
        $sql_select = "SELECT * FROM britishcat WHERE Email='$to_email'";
        ...
        if ($result && mysqli_num_rows($result) > 0) 
        {
            ...
            {
                $sql_delete = "DELETE FROM britishcat WHERE Email='$to_email'";
