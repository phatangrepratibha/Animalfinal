...
if (isset($_POST['accept']) && isset($_POST['email'])) 
{
    ...
    $subject = "Accepting the Maine Coon Cat Adoption Request";
    $body = "Hello Sir/Mam,
            We are grateful to inform you that your adoption request of maine coon cat
    ...
    {
        $sql_select = "SELECT * FROM mainecooncat WHERE Email='$to_email'";
        ...
        if ($result && mysqli_num_rows($result) > 0) 
        {
            ...
            {
                $sql_delete = "DELETE FROM mainecooncat WHERE Email='$to_email'";
